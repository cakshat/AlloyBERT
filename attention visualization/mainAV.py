...
from utilsAV import find_positions, make_the_words, get_sample_article, scale, make_html
...
weights_path = r"checkpoints\finetune\finetune-1129_0720\model.pt"
model.load_state_dict(torch.load(weights_path)['model_state_dict'], strict=False)
tokenizer = RobertaTokenizerFast.from_pretrained(config['paths']['tokenizer'])
